...
This chart is a scalable version of Bitnami [WordPress](https://github.com/bitnami/containers/tree/main/bitnami/wordpress) chart with some additional configurations.
...
| `ingress.tlsClusterIssuer`         | Generate SSL using cert-manager cluster-issuer                                                                                               | `"letsencrypt-prod"`                  |
...
| `persistence.filebrowser.enabled`                      | Enable filebrowser container                                                                                  | `false`                 |
| `persistence.filebrowser.baseUrl`                      | Filebrowser container basepath URL                                                                            | `/filebrowser`                  |
| `persistence.filebrowser.port`                         | Filebrowser container port                                                                                    | `8000`                  |
...
Add support for scalable pvc with ReadWriteMany (RWX) access mode.
